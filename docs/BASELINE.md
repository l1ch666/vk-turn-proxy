...
3. Start the matching client and enable authenticated diagnostics. The harness
   ...
   [DTLS_IDENTITY.md](DTLS_IDENTITY.md), client authorization is documented in
   [CLIENT_AUTH.md](CLIENT_AUTH.md), and diagnostics token generation and
   endpoint security are documented in [DIAGNOSTICS.md](DIAGNOSTICS.md).
