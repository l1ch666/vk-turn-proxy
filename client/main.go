...
// applyBrowserProfileFhttp applies consistent User-Agent and Client Hints to bypass WAFs
...
func main() {
	...
	n := flag.Int("n", 0, "connections to TURN (default 1 for UDP forwarding, 10 for VLESS)")
	...
	var getCreds getCredsFunc = func(ctx context.Context, s string, streamID int) (string, string, string, error) {
